...
- [x] Enable branch protection on `main` branch
  - [x] (Do not add any bypass list items)
  - [x] Restrict deletions
  - [x] Require pull request before merging
    - [x] Require 1 approval
    - [x] Require conversation resolution before merging
  - [x] Require status checks: `unit-tests`, `integration-tests`
...
- [x] Actions/General Settings
  - [x] Verify GitHub Actions permissions are "Read" (not "Read and Write")

**Manual Tasks (GitHub Web UI: `homebrew-tap` repository):**
- [x] Enable minimal ruleset protection on default branch
  - [x] Block force pushes (**do NOT** require PRs, that would break automated formula updates)

**Workflow Transition:**
- [x] Commit Story E.d changes to main (final direct commit)
- [x] Enable branch protection immediately after
- [x] All future work uses PR workflow per `docs/guides/developer/production-mode.md`
